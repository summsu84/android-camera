      ...
      <b-row>
        ...
        <b-col cols="12" md="6">
          <b-card
            ...
            footer-tag="footer">
            <div slot="header">
              <i class="fa fa-align-justify"></i> <strong>Collapse</strong>
              <small>with <code>v-b-toggle</code> directive</small>
            </div>
            <div>
              <!-- Using modifiers -->
      ...
      <b-row>
        <b-col cols="12" md="6">
          <b-card
            ...
            <div slot="header">
              <i class="fa fa-align-justify"></i> <strong>Collapse</strong>
              <small>with <code>visibility</code></small>
            </div>
            <div>
        ...
        <b-col cols="12" md="6">
          <b-card
            ...
            <div slot="header">
              <i class="fa fa-align-justify"></i> <strong>Collapse</strong>
              <small>with <code>v-model</code></small>
            </div>
            <div>
      ...
      <b-row>
        ...
        <b-col cols="12" md="6">
          <b-card
            ...
            <div slot="header">
              <i class="fa fa-align-justify"></i> <strong>Collapse</strong>
              <small><code>accordion</code> support</small>
            </div>
            <div role="tablist">
