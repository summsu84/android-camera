(function(global) {
    ...
    //메시지 응답 파라미터
    Const.responseMessageFromDB = "DB로 부터 성공적으로 메시지를 수신하였습니다.";
    Const.responseMessageFromDBError = "DB로 부터 성공적으로 메시지를 수신 하지 못했습니다.";
    Const.responseMessageFaceNotFound = "얼굴을 찾지 못했습니다.";
    Const.responseMessageFaceDetectionError = "얼굴 인식 중 오류가 발생하였습니다.";
